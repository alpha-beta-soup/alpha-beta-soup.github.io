...
The end result is this [interactive map](http://www.nearimprov.com/train-landscapes).{% sidenote 'sn-id-note-on-tiles' 'The map tiles are now broken, as AWS is not free, and I was not willing to pay to host them.' %}
