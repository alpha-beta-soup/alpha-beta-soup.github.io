    ...
    <section>
      ...
      <div className="mb-8">
        <Image
          ...
          priority
        />
        <p className="mb-4">👋 I'm Richard, a Kiwi digital geographer. I'm available for contract work in the following areas:
        </p>
        <ul className="mb-4">
            <li>
        ...
        <p>In a front-end web development context, I particularly like working with React and Redux, but I'm at home with other tech stacks; let's talk.</p>
        </div>
      <div className='mb-8'>
