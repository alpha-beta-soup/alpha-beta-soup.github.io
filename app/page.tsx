  ...
  return (
    <section>
      ...
      <div className="mb-8">
        ...
        <p className="mb-4">When you hire me, it's a bit like <span className='hashtag'>#shoplocal</span>. You're not helping a CEO afford a new car, you're helping my daughter go to her Irish dancing lessons. I won't overspec, and I won't overcharge. I live in a rural area and I'm happy to pass some of those lifestyle savings on to you.</p>
        <p className="mb-4">I don't do social media (not even LinkedIn); <a href="https://www.artofmanliness.com/character/advice/sunday-firesides-social-media-is-extending-everyones-adolescence/" target="#">I don't think it's good for people</a>. But you can still email me at <a href="mailto:richard.m.law@gmail.com">richard.m.law@gmail.com</a> and we can arrange to talk further.</p>
        </div>
      <div className='mb-8'>
