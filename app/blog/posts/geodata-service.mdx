...
publishedAt: 2016-01-16T21:04:51+1300
summary: "A link to a tutorial for building a geodata web service with Node, Express, PostgreSQL and Amazon RDS."
category: [Professional]
tags: ["PostGIS", "Node", "Express", "GeoJSON", "API", "WebSockets"]
---
...
I also have the beginnings of a QGIS plugin that connects to a specified WebSocket and will render arriving messages, provided they come as GeoJSON or something QGIS can understand.
