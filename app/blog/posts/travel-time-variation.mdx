...
publishedAt: 2014-06-13T17:44:17+1200
tags: [Portfolio, Wellington, Bus, Travel Time, Travel Time Variability]
summary: 'An analysis of travel time variation for the Airport Flyer bus route in Wellington, New Zealand, using real-time information (RTI) data. The analysis compares travel times during ordinary weekdays, school holiday weekdays, and weekends, highlighting the impact of school-related congestion on bus travel times and variability.'
---
...
![Airport Flyer travel time comparison](/images/posts/travel-time-variation/airport91_ttcomparison.png)
...
<NewThought title="What can cause variation in travel time apart from school-related congestion?">
...
### Busses take longer and are less dependable

What does that mean? It means that: 

- Buses are generally getting **stuck in school traffic**, causing people to be **later than they otherwise need to be**, or making people feel they need to leave home earlier than otherwise (to avoid missing the bus).
- **Buses are more late more often**.
- Public transport users have **less certainty about their arrival time**.
- The **schedule becomes less useful** as a tool to **reduce the amount of time you spend waiting**.
