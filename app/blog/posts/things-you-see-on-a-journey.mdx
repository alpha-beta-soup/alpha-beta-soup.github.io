...
publishedAt: "2015-06-01T23:07:10+1200"
subtitle: "A tutorial on GRASS, the UNIX shell, and Leaflet"
summary: "A tutorial on using GRASS, Git, Leaflet, bash, Javascript, CSS, HTML, and hosting map tiles on Amazon AWS. The tutorial takes a tangible (albeit frivolous) problem to completion: identifying the land that you can feasibly see from the train in the central plateau of New Zealand. The tutorial uses a realistic combination of tools to solve it, and shows how these separate tools come together."
category: [Professional,Tutorials]
tags: [Portfolio, GRASS GIS, Git, Leaflet, Bash, JavaScript, CSS, HTML, Amazon AWS, GIS]
---

!["What you'll be making: identifying the land that you can feasibly see from the train in the central plateau of New Zealand.](/images/posts/things-you-see-on-a-journey/example.png "What you'll be making: identifying the land that you can feasibly see from the train in the central plateau of New Zealand.")
...
The end result is this [interactive map](http://spatialparalysis.xyz/train-landscapes).

<Marginalia side="left" marker="*">
**Update:** _The live example is now broken,_ as I was not willing to pay to host the tiles on AWS S3 for long. Sorry.
</Marginalia>

## What I can't cover

I will not cover [beginning with Git](http://readwrite.com/2013/09/30/understanding-github-a-journey-for-beginners-part-1), or fundamental Git concepts. But you'll learn some commands and how to host an interactive map on the Internet for free with Github pages. I will not cover getting started with GRASS. Although this won't be a terrible introduction, I'm not detailing introductory concepts or using the GUI. I had the benefit of a hands-on GRASS introduction at the DMS/NIWA workshop. I won't be discussing web hosting of maps in much depth. I'm not yet much of a web developer, and I've only tinkered with Amazon AWS to get this to work. I'm not an authority.

<NewThought title="If you need more help, try these GRASS resources">
...
What could be taken into consideration in this case, from a spatial perspective? The most straightforward ideas include: what is the terrain like? 
<Marginalia side="left" marker="*">Hills block views of what is behind them.</Marginalia>
...
<Marginalia side="left" marker="*">
**Disclaimer:** I don't actually know if this is proper practice for writing what is essentially help documentation. I can't imagine it's too far from this.
</Marginalia>
...
![rviewshed is fast in Grass 7.0](/images/posts/things-you-see-on-a-journey/grass70_rviewshed.gif)
...
<Marginalia side="left" marker="*">
I realise now that it would be smarter to combine the intermediate layer with the pattern-match layers as part of the above loop... but at the price of one additional `r.series` it ain't the end of the world.
</Marginalia>
...
The final output is simply a GeoTiff. Try opening it in QGIS if you have been playing along at home. If you're just reading, then in the [interactive map](https://spatialparalysis.xyz/train-landscapes), the output GeoTiff is the special coloured layer you see on top of the basemap.
...
<NewThought title="Don't know what tiles are?">
...
![Screenshot from QGIS 2.8, of the Landcare Research WMS.](/images/posts/things-you-see-on-a-journey/LR-example.png "Screenshot from QGIS 2.8, of the Landcare Research WMS.")

![Screenshot from QGIS 2.8, QTiles plugin.](/images/posts/things-you-see-on-a-journey/qtiles.png "Screenshot from QGIS 2.8, QTiles plugin.")
...
![](/images/posts/things-you-see-on-a-journey/aws1.png)

![](/images/posts/things-you-see-on-a-journey/aws2.png)
...
![](/images/posts/things-you-see-on-a-journey/aws3.png)

![](/images/posts/things-you-see-on-a-journey/aws4.png)
